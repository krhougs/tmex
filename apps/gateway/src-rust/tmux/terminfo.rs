pub const XTERM_GHOSTTY_TERMINFO_SOURCE: &str = r#"xterm-ghostty|ghostty|Ghostty,
...
const HEREDOC_MARKER: &str = "TMEX_TERMINFO_EOF";
...
mod tests {
    ...
    #[test]
    fn embeds_the_complete_ghostty_terminfo_install_script() {
        assert!(XTERM_GHOSTTY_TERMINFO_SOURCE.starts_with("xterm-ghostty|ghostty|Ghostty,"));
        assert!(XTERM_GHOSTTY_TERMINFO_SOURCE.contains("setrgbf="));
