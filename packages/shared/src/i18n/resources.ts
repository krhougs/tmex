...
export const I18N_RESOURCES = {
  ...
  "translation": {
    ...
    "terminal": {
      ...
      "filePasteNoRoot": "The current pane directory is not in a writable file root",
  ...
  "translation": {
    ...
    "terminal": {
      ...
      "filePasteNoRoot": "当前 pane 目录未配置可写文件根，无法传输文件",
  ...
  "translation": {
    ...
    "terminal": {
      ...
      "filePasteNoRoot": "現在のペインのディレクトリは書き込み可能なファイルルートに含まれていません",
