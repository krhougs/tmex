...
export const I18N_RESOURCES = {
  ...
  "translation": {
    ...
    "terminal": {
      ...
      "filePasteRejected": "{{count}} folder or unavailable item(s) were skipped; only regular files are supported",
  ...
  "translation": {
    ...
    "terminal": {
      ...
      "filePasteRejected": "已跳过 {{count}} 个文件夹或不可用项目；当前仅支持普通文件",
  ...
  "translation": {
    ...
    "terminal": {
      ...
      "filePasteRejected": "{{count}} 件のフォルダーまたは利用できない項目をスキップしました。通常のファイルのみ対応しています",
